...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "danceamole").glob("**/*.py"):
    ...
    if (
        ...
        print("Checking that danceamole/__init__.py and setup.py coincide...")
        exit_code = call_and_report(
            verb="check that danceamole/__init__.py and setup.py coincide",
            cmd=[
                sys.executable,
        ...
        print("Skipped checking that danceamole/__init__.py and setup.py coincide.")
